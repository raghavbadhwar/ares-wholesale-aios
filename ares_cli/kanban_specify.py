...
Used by ``ares kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``ares_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Ares Agent board.
...
def _profile_author() -> str:
    """Mirror of ``ares_cli.kanban._profile_author``. Kept local to
