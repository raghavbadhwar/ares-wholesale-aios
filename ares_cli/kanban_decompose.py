...
Invoked by ``ares kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Ares Agent board.
...
def _profile_author() -> str:
    """Mirror of ``ares_cli.kanban._profile_author``."""
    return (
        os.environ.get("ARES_PROFILE")
