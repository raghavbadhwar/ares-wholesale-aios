"""
Skills configuration for Ares Agent.
`ares skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.ares/config.yaml under:
...
from ares_cli.config import cfg_get, load_config, save_config
from ares_cli.colors import Colors, color
from ares_cli.platforms import PLATFORMS as _PLATFORMS
