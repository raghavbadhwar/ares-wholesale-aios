# Ares Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.ares/plugins/ares-achievements/state.json` (existing unlock state)
  - `~/.ares/plugins/ares-achievements/scan_snapshot.json` (new)
  - `~/.ares/plugins/ares-achievements/scan_checkpoint.json` (new)
