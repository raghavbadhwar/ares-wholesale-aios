# Ares Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.ares/plugins/ares-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.ares/plugins/ares-achievements/scan_checkpoint.json`.
