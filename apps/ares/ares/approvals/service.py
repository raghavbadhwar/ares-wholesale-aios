...
DEFAULT_APPROVAL_REQUIRED_ACTIONS = {
    ...
    "review_payment_reconciliation",
    "review_bank_statement_reconciliation",
    "review_tds_tcs_computation",
    "review_composition_scheme_guard",
    "export_accounting_sync",
    "prepare_gstr1_return",
    "review_itc_reconciliation",
    "prepare_eway_bill",
    "schedule_supplier_payments",
    "plan_beat_route",
    "review_principal_brand_plan",
    "review_scheme_claim_reconciliation",
    "review_grn_three_way_match",
    ...
    "change_credit_limit",
    "apply_scheme_offer",
    "review_return_damage_resolution",
    "onboard_new_party",
    "prepare_logistics_dispatch",
    "review_festive_stocking_plan",
    "review_mandi_price_alert",
    "submit_gstn_api_request",
    "create_payment_gateway_link",
    "request_account_aggregator_consent",
    "review_account_aggregator_credit_signal",
    "sync_ondc_catalogue",
    "review_saas_control_plane_contract",
