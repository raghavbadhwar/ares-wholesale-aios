...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from ares_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ARES_OVERLAYS
        overlay = ARES_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify ares doctor recognizes Xiaomi env vars."""
