...
The main() function in ares_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `ares -c model`
...
def _build_parser():
    """Build a minimal replica of the ares top-level parser."""
