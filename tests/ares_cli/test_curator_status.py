"""Tests for `ares curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import ares_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated ARES_HOME with real agent-created skills on disk."""
    home = tmp_path / ".ares"
    skills = home / "skills"
    ...
    from ares_cli import curator as curator_cli
