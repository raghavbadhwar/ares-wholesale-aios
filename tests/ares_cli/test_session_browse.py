"""Tests for the interactive session browser (`ares sessions browse`).
...
from ares_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """ares sessions browse should be parseable."""
        from ares_cli.main import main as _main_entry
